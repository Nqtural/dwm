...
static const char *colors[][3]      = {
	/*               fg            bg        border   */
	[SchemeNorm] = { col_subtext1, col_base, col_surface0 },
	[SchemeSel]  = { col_text,     col_base, col_lavender },
};
...
/*                                                                                      background       input            selected_bg      selected_fg */
static const char *dmenucmd[] = { "dmenu_run", "-m", dmenumon, "-fn", dmenufont, "-nb", col_base, "-nf", col_text, "-sb", col_mauve, "-sf", col_base, NULL };
